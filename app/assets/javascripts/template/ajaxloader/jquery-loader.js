...
(function ($) {
    $.loader_ext = {
        ...
        defaults: {
            ...
            title: '', //文字
            isOnly: true,
            imgUrl: 'template/ajaxloader/images/loading[size].gif',
            onShow: function () {
            },  //打开回调
            onClose: function () {
            }  //关闭回调
        ...
        set_css: function () {
            ...
            loader.css({
                'margin-top': ((height-height*0.2) - ops.size) / 2 + ops.position[0],
    ...
    // 简单开启关闭以及设置模板
    $.loader = {
        tmpl: '<div class="loading_wrp"><div class="loading ${Class}"><span>${Title}</span></div></div>',
